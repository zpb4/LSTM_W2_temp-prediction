...
torch.save(model,'./out/lstm_w2-output-temp_90-24.pt')

# -----------------------------------
# Step 6: Evaluation on Validation Set (full training set here)
# -----------------------------------
...
plt.plot(dates,unscale_true,color='black')
plt.plot(dates,unscale_preds,color='green',alpha=0.5)  # Perfect prediction line
plt.legend(['W2','LSTM'])
plt.xlabel("Days")
plt.ylabel("Temp (C)")
